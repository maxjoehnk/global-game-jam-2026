...
public partial class JensSpahnFordert : Control
{
    ...
    // This code is mostly generated by AI
    private void ParseQuotes(byte[] body)
    {
        try
        {
            ...
            HtmlNodeCollection? tableRows = htmlDoc.DocumentNode
            ...
            foreach (HtmlNode? row in tableRows)
            {
                ...
                HtmlNode? dateNode = row.SelectSingleNode(".//td[last()]"); // Assumes date is in the last td

                if (linkNode != null && dateNode != null)
                {
                    string quoteText = (linkNode.InnerText?.Trim() ?? "").Replace("&quot;", "\"");
